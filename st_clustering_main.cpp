...
int main(int argc,char** argv){
	...
	printf("Spatio-temporal clustering finished, warn st cluster size=%d, fatal st cluster size=%d, fatal st cluster in test set=%d\n",st_cluster_size(warn_st_clusters),st_cluster_size(fatal_st_clusters),st_cluster_size_by_date(fatal_st_clusters,fatal_dates,test_start_date));
